...
- **Blockchain**: investigate_blockchain — read-only Blockchair evidence for addresses, transactions, privacy heuristics, and chain stats on documented Bitcoin-like chains and Ethereum; use it for on-chain investigation rather than price analysis
